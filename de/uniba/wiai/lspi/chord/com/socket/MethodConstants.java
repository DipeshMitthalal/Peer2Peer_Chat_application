...
final class MethodConstants {
	...
	/**
	 * Integer constant used to route the message using finger tables
	 */
	public static final int SEND_MESSAGE = 12;
	/*
	 * Integer constant used to route message using finger tables and no wait
	 */
	public static final int SEND_MESSAGE_NO_WAIT = 13;
	public static final int DIRECT_SEND_BACK = 14;
	/**
	...
	static final String[] METHOD_NAMES = new String[] { "findSuccessor",
			...
			"removeReplicas", "retrieveEntries", "shutdown","send_message","send_message_no_wait", "direct_send_back" };
